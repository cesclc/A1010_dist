"""
huggingface_llm.py - HuggingFaceLlm class , for accessing different HuggingFace LLMs
"""
...
class HuggingFaceLlm(Llm):
    ...
    # Include Qwen models eg see:  https://huggingface.co/Qwen/Qwen2-7B-Instruct
    # Context window size no of IN+OUT tokens:
    ctxw_sizes = {'gpt-3.5-turbo': '16k', 'gpt-4o': '128k', 'gpt-4-turbo': '128k', 'gpt-4': '8k', 'gpt-4o-mini': '128k', 'dall-e-3': '99k', 'tts-1': '99k'}
    # Cost per million tokens In/Out
    costper = {'gpt-3.5-turbo': '.5/1.5', 'gpt-4o': '5/15', 'gpt-4-turbo': '10/30', 'gpt-4': '30/60', 'gpt-4o-mini': '.00015/.00060', 'dall-e-3': '99/99', 'tts-1': '99/99'}
    ...
    def create_client(self, model_):
        ...
        #     #   unfortunately deleted keys will still work for (2 hours?) after they're deleted: (in HuggingFace dashboard)
