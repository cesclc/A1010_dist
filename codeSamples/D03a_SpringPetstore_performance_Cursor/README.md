...
## MB NOTES
See DemoSnippets.md:D03_SpringPetstore
Clone from https://github.com/spring-projects/spring-petclinic
See chat history and code results / details in:
  speedup.md
  speedup02.md
See my commit messages in:
  gitlog.txt
